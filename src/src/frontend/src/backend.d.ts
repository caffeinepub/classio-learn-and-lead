...
export interface backendInterface {
  ...
  login(username: string): Promise<{ ok: AppUserData } | { err: string }>;
  createSchoolAdmin(creatorId: string, name: string, email: string, username: string, schoolName: string): Promise<{ ok: AppUserData } | { err: string }>;
  createTeacher(creatorId: string, name: string, email: string, username: string, gradeAssigned: bigint): Promise<{ ok: AppUserData } | { err: string }>;
